...
original_dataset_path = r'C:\Users\leeji\Desktop\PythonWorkspace\Space_Debris_Project_Yolo\data\dataset'

# 2. 'debris' 클래스만 담을 새로운 데이터셋 폴더 경로 (이 이름 그대로 사용 권장)
new_dataset_path = r'C:\Users\leeji\Desktop\PythonWorkspace\Space_Debris_Project_Yolo\data\debris_only_dataset'
# -----------------------------------------
